...
<template>
  ...
  <section class="products-section">
    <ul class="products-list">
      <li @click="getProductPage(product.productId)" class="product-item" v-for="product in products">
