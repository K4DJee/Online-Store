	...
	<div v-if="data" class="product-page">
		<div class="container">
			...
			<div class="reviews-container">
				<h2 class="review-title-h2 text-2xl">Отзывы товара: ({{ reviewRows?.reviewRows.length }})</h2>
                ...
                >
					...
					<div class="addReview-2c">
						<textarea placeholder="Напишите свои ощущения о товаре"></textarea>
					</div>
