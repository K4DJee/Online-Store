    ...
    async function codeRecover(){
      errorMessage.value = '';
        ...
        try{
            ...
            const data = await $fetch<responseCodeRecover>('http://localhost:8000/api/account-recover-code', {
              method:'POST',
              body:{
                codeObject
              }
...
<template>
    ...
    <h2 class="recover-title">На вашу почту был отправлен код, введите его </h2>
