<template>
    <div class="userReviewCard">
        <div class="h-10 flex items-center gap-2.5 justify-between">
            <div class="w-25 flex gap-2.5 items-center">
                <NuxtImg class="rounded-[52px] w-[35px]"
                 :src="'https://i.pinimg.com/736x/11/1c/7f/111c7f70a48c84f490574de35e7cb4c5.jpg'"></NuxtImg>
                <h2>{{ userReviewCard.reviewUsername }}</h2>
            </div>
            <div class="flex gap-2.5 items-center">
                <h2>{{ formatDate(parseDate(userReviewCard.createdAt)) }}</h2>
