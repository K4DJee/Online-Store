<template>
	...
	>
		<div class="flex items-center gap-2.5 justify-between h-full">
			...
			<div
				class="userReviewCard-btn-container flex gap-2.5 h-full items-start"
			>
				<button
					class="userReviewBtn h-7.5 w-7.5 hover:bg-green-100 transition-colors"
				...
				>
					...
					>
						<path
							d="M27.9385 3.1866L25.8139 1.06201C25.1059 0.354004 24.1781 0 23.2504 0C22.3226 0 21.3948 0.354004 20.6874 1.06145L16.4682 5.28061L14.5 7.24887L0.727885 21.0205L0.0085526 27.49C-0.082072 28.3045 0.559663 29 1.35659 29C1.407 29 1.45798 28.9972 1.50896 28.9915L7.97389 28.2773L21.7511 14.5L23.7188 12.5323L27.9379 8.31314C29.3539 6.89713 29.3539 4.60205 27.9385 3.1866ZM6.7261 25.6803L2.89834 26.1028L3.32485 22.2688L16.4224 9.17125L18.1794 7.41426L21.5857 10.8206L19.8287 12.5776L6.7261 25.6803ZM26.0155 6.3902L23.5075 8.89824L20.1017 5.49187L22.6098 2.98383C22.8409 2.75273 23.1105 2.71818 23.2504 2.71818C23.3903 2.71818 23.6604 2.75273 23.891 2.98383L26.0155 5.10842C26.369 5.46242 26.369 6.03732 26.0155 6.3902Z"
							fill="#8EEC00"
						/>
					</svg>
				</button>
				<button
					class="userReviewBtn h-7.5 w-7.5 hover:bg-red-100 transition-colors"
