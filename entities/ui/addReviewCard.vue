...
<template>
	<div class="addReview-container">
					...
					<div class="addReview-2c">
						<textarea v-model="comment" placeholder="Напишите свои ощущения о товаре"></textarea>
					</div>
					<div class="addReview-3c">
						<button @click.prevent="addReview(productId, rating, comment, sellerName)">Оставить отзыв</button>
					</div>
				</div>
</template>
<style>
